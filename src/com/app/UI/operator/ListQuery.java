...
public class ListQuery extends JPanel {
	...
	public ListQuery() {
		...
		btnNewButton.setBounds(79, 289, 92, 23);
		setLayout(null);
		add(btnNewButton);
		...
		lblNewLabel.setBounds(21, 189, 54, 15);
		add(lblNewLabel);
		
		textOrderId = new JTextField();                     //机票票号，即ticket_id
		textOrderId.setBounds(100, 183, 118, 21);
		add(textOrderId);
		...
		lblNewLabel_3 = new JLabel("当前操作员销售订单查询");
		lblNewLabel_3.setFont(new Font("微软雅黑", Font.BOLD, 16));
		lblNewLabel_3.setBounds(31, 47, 244, 37);
		add(lblNewLabel_3);
	}	
	/*根据orderer_id查询订单记录，包括退票的记录
	 * 
	 */
	public  void initData(){
		vecOrderer=orderDaoImpl.selectOrdererId(orderer);
